$( document ).ready( function(){
    ...
    var leadership = [
        ...
        },
        {
            ...
            "title": "Chief Appraiser, InHouseUSA",
            "desc": [
                "Al joined InHouseUSA in 2012 as Chief Appraiser with 35 years of experience in the appraisal industry. He oversees appraisal review and reviewers, maintains the fee panel appraiser list, oversees compliance, including state and federal compliance - licensing, AMC regulation, surety bonds, and authors internal policies and procedures for escalation matters.",
                "Al received his Senior Residential Appraiser (SRA) designation from the Appraisal Institute in 1988 and is a Certified Residential Appraiser in the States of Florida and Virginia. He is also a member of NEFAR Board of Realtors (Jacksonville, Florida), a Special Magistrate for Value Adjustment Board (Duval Country, State of Florida), an Expert Witness (Duval County, Florida), and a Fee Panel Appraiser for the Veterans Administration (2005).",
                "Prior to joining InHouseUSA, Al managed appraisal panels for a national AMC, was Regional Appraisal Manager for national lending institutions and accumulated over 15 years of fee appraisal experience in Florida, Utah and California."
                ]               
        },
        {
            "id": "brad",
        ...
        },
        {
            "id": "chris",
            "name": "Chris Schulz",
            "title": "Senior Manager, Appraiser Development",
            "desc": [
                "Chris joined TNG in the fall of 2017, coming from a varied background in real estate including Appraisal Review, Asset Recovery, Retail Brokerage and Entrepreneurship. Chris is a business major and candidate member of the Appraisal Institute of Canada.",
                "Chris has been brought on board to build new processes to strengthen TNG’s appraiser network, and to ensure that our clients enjoy the highest levels of quality and service. His strong analytical and problem-solving skills will be key in developing new initiatives to measure quality, consistency and timeliness of our appraiser partners’ work product.",
                ]               
        },

        {
            "id": "cynthia",
            "name": "Cynthia Dymon",
            "title": "Cynthia Dymon's title ",
            "desc": [
                "Cynthia Dymon's  par 1",
                "Cynthia Dymon's  par 2",
                "Cynthia Dymon's  par 3"
                ]               
        },
        {
            "id": "newton",
        ...
        {
            "id": "guillermo",
            "name": "Guillermo Cosio",
            "title": "Vice President, Sales, Latin America",
            "desc": [
                "Guillermo joined the TNG group in September 2015 to expand our NRS presence in Mexico and Latin America, he is based in Mexico City. Guillermo has over 35 years of experience and his background and expertise span from Corporate Banking Operations to Consumer Lending Services.",
                "His most recent tenure at Scotiabank was to lead the Retail and Small Business Collections and Recoveries process for 28 countries across LATAM and the Caribbean. Prior to that, Guillermo was Chief Collections Officer for GE Money Bank, Vice President Operations LAC-IDC for American Express and Chief Administration Officer for Chase Manhattan Bank, and held senior management roles at Citibank Mexico and HSBC Mexico.",
                "Guillermo is a subject matter expert in the Credit and Collections, with proven success records deploying technology, operational improvements, process reengineering, staffing, sourcing and leadership skills required to improve credit portfolio recovery ratios.",
                "He has a BA in International Affairs from the Universidad Nacional Autónoma de México and a Business Diploma from the IPADE Business School in Alta Dirección de Empresas"
                ]               
        },
        {
            "id": "justin",
...

        {
            ...
            "title": "Vice President, Business Development, InHouseUSA",
            "desc": [
                "Lance focuses on growing InhouseUSA’s market share through establishing & maintaining relationships with prospective lenders-clients.",
                "Specializing in the digital marketplace, Lance brings a unique vision and extensive experience in developing and executing effective strategies to grow businesses. Lance has been a licensed real estate broker since 2006 and has developed a successful real estate brokerage firm.",
                "Prior to that, as the Executive Vice President of Autofusion, he and his team revolutionized the automotive industry’s digital footprint that is the standard today. Using a strong work ethic and a commitment to succeed learned as a professional motocross rider Lance transitioned Autofusion from the red to annual sales just under $13 million in under 4 years.",
                "A Graduate of Coleman University with a Bachelor of Computer Science provides Lance with the technical knowledge to help understand and remedy the technical challenges in the appraisal space.",
                ]               
        },
        {
            "id": "david",
            "name": "David Vitale",
            "title": "Senior Vice President of Business Development, InHouseUSA",
            "desc": [
                "David Vitale joined InHouse USA in February 2018 as Senior Vice President of Business Development.  He is a seasoned executive with over 20 years in mortgage, finance and software experience. With positions at Ellie Mae and Appraisal Scope, he has been concentrated in SaaS for the Mortgage Industry for the past 6 years.   Most recently David helped grow Appraisal Scope into a national presence before it was acquired.  Leveraging old relationships while building new ones, David will be responsible for National accounts and new logos becoming InHouse software clients.  Besides work, David enjoys hiking, motorcycles and the New England Patriots.  Although originally from Boston, David resides in San Diego with his wife and two dogs.",
                ]               
        },
